 ...
 * 用shader来渲染不同的图像
 */
public class ShaderL extends View implements Runnable{
    /*声明bitmap*/
    ...
    public ShaderL(Context context) {
        super(context);
        init();
    }

    public ShaderL(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ShaderL(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public ShaderL(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
